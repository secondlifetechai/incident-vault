  ...
  return (
    <div className="w-full">
      ...
      <div className="text-center mb-8">
        ...
        <h1 className="mt-6 bg-gradient-to-b from-yellow-500 via-white to-blue-800 bg-clip-text text-4xl font-bold tracking-tight text-transparent">
          Track Your Report
          <span className="block bg-gradient-to-r from-sky-600 to-blue-800 bg-clip-text text-transparent">
            Stay Informed
          </span>
        </h1>
          ...
          >
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <button
                type="submit"
                disabled={loading}
                className="w-full bg-gradient-to-r hover:from-yellow-400 hover:via-gray-600 hover:to-blue-500 from-yellow-800 via-black to-blue-600 py-3 px-4 rounded-xl transition-all duration-200 
